...
public class TestSubstrates : IClassFixture<WebApplicationFactory<Program>>
{
        ...
        var expectedContent = new List<Sample>()
    {
        ...
        var response = _httpClient.GetAsync("api/v1/substrates").Result;
    ...
    public async Task WhenCallingGetSubstratesByID_ThenTheAPIReturnsExpectedResponse()
    {
        ...
        var response = _httpClient.GetAsync("api/v1/substrates/2").Result;
    ...
    public async Task WhenCallingUpdateSubstratesByID_ThenTheAPIReturnsExpectedResponse()
    {
        ...
        var response = await _httpClient.PutAsync("api/v1/substrates/2", GetJsonStringContent(elementToUpdate));
